  ...
  void _pickFiles() async {
    ...
    if (pathlist.length > 0) {
      for (var path in pathlist) {
        ...
        asset = File(path);
        listIndexVal = pathlist.indexOf(path);
        await _upload(asset!);
        print("upload donee");
        print(path);
        // file.deleteSync();
                                                ...
                                                Padding(
                                                  ...
                                                  child: ListTile(
                                                    ...
                                                    leading: ConstrainedBox(
                                                      ...
                                                      child: Image.file(assets,
                                                          fit: BoxFit
                                                              .cover), //Image.asset(asset, fit: BoxFit.cover),
                                                    ),
                                                  ),
                                                ),
                                                //  ListView.builder(
...
Widget buildloader(int? indexvalue, int index) {
  if (indexvalue == index) return Text("zero");
